...
import {
  CalendarDays, CalendarPlus, CornerDownLeft, LayoutDashboard, Repeat, Search, Sparkles, Users,
} from "lucide-react";
...
interface Cmd {
  id: string;
  group: "Hành động" | "Nhân viên" | "Ca trực";
  label: string;
  hint?: string;
...
export function CommandSearch() {
  ...
  /* lịch tháng hiện tại — tìm kiếm ca trực */
