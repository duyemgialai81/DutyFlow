...
import { Button, Field, inputCls, Modal, Select, SHIFT_META, Skeleton, Stepper } from "../ui";
      ...
      {step === 0 && (
        <div className="anim-rise grid gap-4 sm:grid-cols-2">
          <Field label="Ngày bắt đầu">
            <input type="date" min={todayISO()} value={startDate} onChange={(e) => setStartDate(e.target.value)} className={inputCls} />
          </Field>
          <Field label="Ngày kết thúc">
            <input type="date" min={startDate} value={endDate} onChange={(e) => setEndDate(e.target.value)} className={inputCls} />
          </Field>
